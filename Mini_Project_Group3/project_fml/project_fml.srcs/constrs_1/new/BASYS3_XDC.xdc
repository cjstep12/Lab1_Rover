...
# Clock signal
set_property -dict { PACKAGE_PIN W5   IOSTANDARD LVCMOS33 } [get_ports clock100]
...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {SENSA}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENSA}]
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {IN4}]
...
##Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {ENB}]
set_property IOSTANDARD LVCMOS33 [get_ports {ENB}]
##Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {SENSB}]
set_property IOSTANDARD LVCMOS33 [get_ports {SENSB}]
##Sch name = JA8
...
##Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports {ENA}]
