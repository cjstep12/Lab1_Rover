...
##Pmod Header JB
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports io_scl]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports io_sda]
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33} [get_ports JB3]
set_property -dict {PACKAGE_PIN B16 IOSTANDARD LVCMOS33} [get_ports JB4]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports JB5]
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports JB6]
